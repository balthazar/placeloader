...
const src = 'https://avatars0.githubusercontent.com/u/6033345?v=3'
...
storiesOf('PlaceLoader', module)
  ...
  `, () => (
    <Example>
      <PlaceLoader colors={['rgba(0, 43, 54, 0.95)', 'rgb(0, 43, 54)']} style={square} />
      <PlaceLoader color='#fdf6e3' kind={2} style={square} />
    </Example>
  ))
